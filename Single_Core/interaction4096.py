...
topo_list=[torus4096,grid4096,linear,cyclic,hypercube4096,quadtree4096]
embed_list=[embedh,embedg,embedz,embedr]
def interaction4096(a,center,num_proc,size,curve,embed_order,topology):
