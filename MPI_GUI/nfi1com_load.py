...
aovr_sum_comms=np.zeros(1)
aovr_sum_vol=np.zeros(1)

comm.Reduce(aloc_comms,aovr_sum_comms,op=MPI.SUM,root=0)
comm.Reduce(aloc_vol,aovr_sum_vol,op=MPI.SUM,root=0)
...
if rank ==0:
	...
	print('\n**The average number of messages was: ', float(aovr_sum_comms[0]/size),'**\n','\n**The average volume was: ', float(aovr_sum_vol[0]/size),'**\n')
